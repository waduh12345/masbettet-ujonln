...
export default function TryoutListPage() {
  ...
  const working = isLoading || isFetching; // Untuk daftar tryout
  const loadingHistory = loadingOngoing || loadingCompleted; // Untuk riwayat ongoing/completed
  const loadingAll = working || loadingHistory; // Untuk keseluruhan tampilan
  ...
  return (
    <div className="space-y-8">
      ...
      <section className="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3">
        {loadingAll && !items.length // Gunakan loadingAll di sini
                  ...
                  <div className="mt-5 grid grid-cols-2 gap-2">
                    ...
                    {isContinuable ? (
                      <Button
                        ...
                        disabled={loadingHistory} // Nonaktifkan jika riwayat sedang dimuat
                      ...
                      <Button
                        ...
                        // Tambahkan loadingHistory di sini
                        disabled={starting || isCompleted || loadingHistory} 
                        title={
                          isCompleted
                      ...
                      >
                        {starting || loadingHistory ? ( // Tampilkan loading spinner jika starting atau history loading
                          <>
                            <Loader2 className="h-4 w-4 animate-spin" />
        ...
        {!loadingAll && items.length === 0 && ( // Gunakan loadingAll di sini
